...
import utils.loss as detect_loss
    ...
    if rank in [-1, 0]:
        ...
        if not opt.resume:
            ...
            if not opt.noautoanchor:
                check_anchors(detect_dataset, model=model, thr=hyp['anchor_t'], imgsz=imgsz, autoAnchor=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/home/chase/shy/testyolo/yolov5/runs/train/exp84/weights/last.pt', help='initial weights path')
